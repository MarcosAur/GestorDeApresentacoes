...
<head>
    ...
    <title>Login - Gestor de Apresentação Gemini</title>
...
<body class="bg-surface text-white font-body antialiased flex items-center justify-center min-h-screen p-6">
    <div class="w-full max-w-md">
        ...
        <div class="bg-surface-container-low p-8 rounded-2xl shadow-2xl border border-outline-variant/10 backdrop-blur-xl">
            <h2 class="text-2xl font-display font-bold mb-8 tracking-tight">Fazer Login</h2>
            ...
            <div class="mt-8 text-center">
                <a href="#" class="text-sm text-secondary hover:underline transition-all">Esqueceu sua senha?</a>
            </div>
        </div>
    </div>
</body>
